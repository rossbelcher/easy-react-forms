...
var reactIs$1 = _interopDefault(require('react-is'));
...
var FormControlData = recoil.atom({
    key: "formStateData",
    default: {}
});
...
var useFormUpdate = function (formId, model) {
    var _a = recoil.useRecoilState(FormControlData), componentData = _a[0], setComponentData = _a[1];
...
var FormWrapper = /** @class */ (function (_super) {
    ...
    FormWrapper.prototype.render = function () {
        ...
        return (React__default.createElement(FormContext.Provider, { value: formId },
            React__default.createElement(FormAttibuteContext.Provider, { value: { disabled: this.props.disabled } }, React__default.createElement(element, props, children))));
    };
    return FormWrapper;
}(React.Component));
...
var EasyTextInput = function (_a) {
    ...
    return (React__default.createElement(React__default.Fragment, null,
        React__default.createElement(FormAttibuteContext.Consumer, null, function (attr) { return (React__default.createElement(React__default.Fragment, null,
            label &&
                React__default.createElement(BaseLabelStyle, { className: required ? 'required' : '', htmlFor: id ? id : nameToUse }, label),
            React__default.createElement(BaseInputStyle, { type: 'text', className: error ? 'error' : '', name: nameToUse, id: id ? id : nameToUse, value: valueToUse, required: required, disabled: disabled || attr.disabled, "data-e2e-id": testingId ? testingId : (id ? id : nameToUse), ref: inputRef, autoComplete: 'off', onBlur: function (e) { setValue(e, true); if (onBlur)
            ...
            error &&
                React__default.createElement(BaseErrorMessage, { className: 'error-message' }, error))); })));
};

exports.TextInput = EasyTextInput;
