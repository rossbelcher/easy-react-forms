import React, { createContext, Component, useContext, useRef, useEffect } from 'react';
import { atom, useRecoilState } from 'recoil';
import stylis from '@emotion/stylis';
import isPropValid from '@emotion/is-prop-valid';
import reactIs$1 from 'react-is';
...
var C__Users_Ross_Documents_easyFormsReact_node_modules_reactIs = createCommonjsModule(function (module) {
...
var unitless_cjs$1 = createCommonjsModule(function (module) {
...
var styledComponents_cjs_8 = styledComponents_cjs.__PRIVATE__;
var styledComponents_cjs_9 = styledComponents_cjs.createGlobalStyle;
var styledComponents_cjs_10 = styledComponents_cjs.css;
var styledComponents_cjs_11 = styledComponents_cjs.isStyledComponent;
var styledComponents_cjs_12 = styledComponents_cjs.keyframes;
var styledComponents_cjs_13 = styledComponents_cjs.useTheme;
var styledComponents_cjs_14 = styledComponents_cjs.version;
var styledComponents_cjs_15 = styledComponents_cjs.withTheme;

var base = "\n    padding: 0.5em;\n    background-color: #FFFFFF;\n    border: 1px solid #d6d6d6;\n    transition: all ease 0.5s;\n    outline: none;\n\n    &.error {\n        border: 1px solid red;\n    }\n\n    &:focus {\n        border-color: black;\n    }\n";
var BaseInputStyle = styled.input(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    ", "\n"], ["\n    ", "\n"])), base);
var BaseCalendarStyle = styled.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n    .DateInput_input {\n        padding: 0;\n        font-size: inherit;\n        width: 7em;\n\n        &:focus + .SingleDatePickerInput {\n            border-color: black;\n        }\n    }\n\n    .SingleDatePickerInput_calendarIcon {\n        margin: 0 5px 0 5px;\n        padding: 5px;\n    }\n\n    .DateInput_input__focused {\n        border-bottom: none;\n    }\n\n"], ["\n    .DateInput_input {\n        padding: 0;\n        font-size: inherit;\n        width: 7em;\n\n        &:focus + .SingleDatePickerInput {\n            border-color: black;\n        }\n    }\n\n    .SingleDatePickerInput_calendarIcon {\n        margin: 0 5px 0 5px;\n        padding: 5px;\n    }\n\n    .DateInput_input__focused {\n        border-bottom: none;\n    }\n\n"])));
var BaseLabelStyle = styled.label(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n    margin-bottom: 0.5rem;\n    display: block;\n\n    &.required::after {\n        content: ' *';\n        color: red;\n    }\n"], ["\n    margin-bottom: 0.5rem;\n    display: block;\n\n    &.required::after {\n        content: ' *';\n        color: red;\n    }\n"])));
var BaseErrorMessage = styled.div(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n    color: red;\n    font-size: 0.9em;\n"], ["\n    color: red;\n    font-size: 0.9em;\n"])));
var BaseTextareaStyle = styled.textarea(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n    ", "\n"], ["\n    ", "\n"])), base);
var templateObject_1, templateObject_2, templateObject_3, templateObject_4, templateObject_5;

var FormControlData = atom({
    key: "formStateData",
    default: {}
});
...
var FormController = /** @class */ (function () {
    ...
    FormController.updateForm = function (id, data) {
    ...
    FormController.setState = function (element, state, callback) {
        ...
        var formState = lodash(this.formState);
...
var useFormUpdate = function (formId, model) {
    var _a = useRecoilState(FormControlData), componentData = _a[0], setComponentData = _a[1];
    var updateFormData = function (value, valid) {
        if (model == undefined)
            return;
        var newData = deepCopy(componentData);
        if (!newData[formId])
            newData[formId] = {};
        var nodeToSet = newData[formId];
        if (model.indexOf('.') > -1) {
            var nameSplit = model.split('.');
    ...
    var modelData = {};
    if (componentData[formId] && componentData[formId][model])
        modelData = componentData[formId][model];
...
var EasyTextInput = function (_a) {
    var model = _a.model, onChange = _a.onChange, onBlur = _a.onBlur, onFocus = _a.onFocus, inputName = _a.inputName, value = _a.value, required = _a.required, label = _a.label, id = _a.id, min = _a.min, _b = _a.max, max = _b === void 0 ? DefaultNumericMax : _b, disabled = _a.disabled, testingId = _a.testingId, defaultValue = _a.defaultValue, unlink = _a.unlink, alphanumeric = _a.alphanumeric, validateOnLoad = _a.validateOnLoad, placeholder = _a.placeholder;
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(FormAttibuteContext.Consumer, null, function (attr) { return (React.createElement(React.Fragment, null,
            ...
            React.createElement(BaseInputStyle, { type: 'text', className: error ? 'error' : '', name: nameToUse, id: id ? id : nameToUse, value: valueToUse, required: required, disabled: disabled || attr.disabled, "data-e2e-id": testingId ? testingId : (id ? id : nameToUse), ref: inputRef, autoComplete: 'off', onBlur: function (e) { setValue(e, true); if (onBlur)
...
export { EasyTextInput as TextInput };
