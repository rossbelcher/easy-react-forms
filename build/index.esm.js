import React, { createContext, Component, useContext, useRef, useEffect, useState } from 'react';
import { RecoilRoot, atom, useRecoilState } from 'recoil';
import require$$3 from '@emotion/stylis';
import require$$5 from '@emotion/is-prop-valid';
import require$$0 from 'react-is';
import require$$7 from 'stream';
import cloneDeep from 'lodash';
import 'prop-types';
import require$$2 from 'classnames';
import require$$3$1 from 'date-fns/isDate';
import require$$4 from 'date-fns/isValid';
import require$$5$1 from 'date-fns/format';
import require$$6 from 'date-fns/addMinutes';
import require$$7$1 from 'date-fns/addHours';
import require$$8 from 'date-fns/addDays';
import require$$9 from 'date-fns/addWeeks';
import require$$10 from 'date-fns/addMonths';
import require$$11 from 'date-fns/addYears';
import 'date-fns/subMinutes';
import 'date-fns/subHours';
import require$$14 from 'date-fns/subDays';
import require$$15 from 'date-fns/subWeeks';
import require$$16 from 'date-fns/subMonths';
import require$$17 from 'date-fns/subYears';
import require$$18 from 'date-fns/getSeconds';
import require$$19 from 'date-fns/getMinutes';
import require$$20 from 'date-fns/getHours';
import require$$21 from 'date-fns/getDay';
import require$$22 from 'date-fns/getDate';
import require$$23 from 'date-fns/getISOWeek';
import require$$24 from 'date-fns/getMonth';
import require$$25 from 'date-fns/getQuarter';
import require$$26 from 'date-fns/getYear';
import require$$27 from 'date-fns/getTime';
import require$$28 from 'date-fns/setSeconds';
import require$$29 from 'date-fns/setMinutes';
import require$$30 from 'date-fns/setHours';
import require$$31 from 'date-fns/setMonth';
import require$$32 from 'date-fns/setQuarter';
import require$$33 from 'date-fns/setYear';
import require$$34 from 'date-fns/min';
import require$$35 from 'date-fns/max';
import require$$36 from 'date-fns/differenceInCalendarDays';
import require$$37 from 'date-fns/differenceInCalendarMonths';
import 'date-fns/differenceInCalendarWeeks';
import require$$39 from 'date-fns/differenceInCalendarYears';
import require$$40 from 'date-fns/startOfDay';
import require$$41 from 'date-fns/startOfWeek';
import require$$42 from 'date-fns/startOfMonth';
import require$$43 from 'date-fns/startOfQuarter';
import require$$44 from 'date-fns/startOfYear';
import require$$45 from 'date-fns/endOfDay';
import 'date-fns/endOfWeek';
import 'date-fns/endOfMonth';
import require$$48 from 'date-fns/isEqual';
import require$$49 from 'date-fns/isSameDay';
import require$$50 from 'date-fns/isSameMonth';
import require$$51 from 'date-fns/isSameYear';
import require$$52 from 'date-fns/isSameQuarter';
import require$$53 from 'date-fns/isAfter';
import require$$54 from 'date-fns/isBefore';
import require$$55 from 'date-fns/isWithinInterval';
import require$$56 from 'date-fns/toDate';
import require$$57 from 'date-fns/parse';
import require$$58 from 'date-fns/parseISO';
import require$$1 from 'react-dom';
import require$$61 from 'react-popper';
...
var FormControlState = function (formId, model) { return atom({
...
var FormController = /** @class */ (function () {
    ...
    FormController.setState = function (element, state, callback) {
        ...
        var formState = cloneDeep(this.formState);
...
var FormAttibuteContext = createContext({ disabled: false });
var FormWrapper = /** @class */ (function (_super) {
    ...
    FormWrapper.prototype.render = function () {
        ...
        return (React.createElement(FormContext.Provider, { value: formId },
            React.createElement(FormAttibuteContext.Provider, { value: { disabled: this.props.disabled } }, React.createElement(element, props, children))));
    };
    return FormWrapper;
}(Component));
...
var EasyTextInput$1 = function (_a) {
    ...
    var uuid = useRef(createUUID());
    var formId = unlink || !context ? null : context;
    var nameToUse = inputName ? inputName : model;
    var _c = useRecoilState(FormControlState(formId || uuid.current, model || inputName)), componentState = _c[0], setComponentState = _c[1];
    ...
    return (React.createElement("div", { className: className },
        React.createElement(FormAttibuteContext.Consumer, null, function (attr) { return (React.createElement(React.Fragment, null,
            ...
            error &&
                React.createElement(BaseErrorMessage, { className: 'error-message' }, error))); })));
};
...
Object.defineProperty(reactOnclickoutside_cjs,'__esModule',{value:true});var react=React,reactDom=require$$1;function _inheritsLoose(subClass, superClass) {
...
var EasyCalendar = function (_a) {
    ...
    var validate = function (setState, date) {
        ...
        if (!isFieldValid(date)) {
            ...
            var error_5 = "Date must be after: ".concat(moment$1(minDate).format(DEFAULT_DATE_FORMAT));
            if (setState)
            ...
            var error_6 = "Date must be before: ".concat(moment$1(maxDate).format(DEFAULT_DATE_FORMAT));
            if (setState)
    ...
    return (React.createElement("div", { className: className },
        React.createElement(BaseThirdPartyCalendarStyle, null),
        React.createElement(FormAttibuteContext.Consumer, null, function (attr) { return (React.createElement(BaseCalendarStyle, { error: error },
            label &&
                React.createElement(BaseLabelStyle, { className: required ? 'required' : '', htmlFor: id ? id : nameToUse }, label),
            React.createElement(_default, __assign({ selected: parsedValue === null || parsedValue === void 0 ? void 0 : parsedValue.toDate(), className: error ? 'error' : '', onChange: setValue, onClose: setValue, dateFormat: 'dd/MM/yyyy', disabled: attr.disabled, monthsShown: months ? months : 2, minDate: parsedMinDate, maxDate: parsedMaxDate, placeholder: placeholder }, calendarProps)),
            error &&
                React.createElement(BaseErrorMessage, null, error))); })));
};
...
var EasyCheckbox = function (_a) {
    ...
    var formId = unlink || !context ? null : context;
    var nameToUse = inputName ? inputName : model;
    var _b = useRecoilState(FormControlState(formId || uuid.current, model || inputName)), componentState = _b[0], setComponentState = _b[1];
    var setComponentData = useFormUpdate(formId, model);
    ...
    return (React.createElement("div", { className: className },
        React.createElement(FormAttibuteContext.Consumer, null, function (attr) { return (React.createElement(React.Fragment, null,
            React.createElement("input", { type: 'checkbox', className: 'chkbx', checked: !!isChecked, name: nameToUse, id: id ? id : nameToUse, required: required, disabled: disabled || attr.disabled, onChange: function (e) { return setValue(e); } }),
            label &&
                React.createElement("label", { htmlFor: id ? id : nameToUse, className: labelClass }, label),
            error &&
                React.createElement(BaseErrorMessage, { className: '' }, error))); })));
};
...
var EasyRadioInput = function (_a) {
    ...
    return (React.createElement("div", { className: className },
        React.createElement(FormAttibuteContext.Consumer, null, function (attr) { return (React.createElement(React.Fragment, null,
            React.createElement("input", { type: 'radio', checked: isChecked, name: nameToUse, id: id, disabled: attr.disabled, required: required, onChange: function (e) { return setValue(e); }, value: value }),
            label &&
...
var EasyTextInput = function (_a) {
    ...
    return (React.createElement("div", { className: className },
        React.createElement(FormAttibuteContext.Consumer, null, function (attr) { return (React.createElement(React.Fragment, null,
            label &&
                React.createElement(BaseLabelStyle, { className: required ? 'required' : '', htmlFor: id ? id : nameToUse }, label),
            React.createElement(BaseSelectStyle, { className: error ? 'error' : '', name: nameToUse, id: id ? id : nameToUse, value: valueToUse, required: required, disabled: disabled || attr.disabled, "data-e2e-id": testingId ? testingId : (id ? id : nameToUse), onBlur: function (e) { setValue(e); if (onBlur)
                    onBlur(e); }, onFocus: function (e) { return onFocus ? onFocus(e) : null; }, placeholder: placeholder, onChange: function (e) { return setValue(e); } },
                addDefault &&
                    React.createElement("option", { value: '' }, defaultText ? defaultText : 'Please Select'),
                items && items.map(function (item, index) {
                    if (item.value !== null && item.value !== undefined)
                        return (React.createElement("option", { key: "".concat(item.value, "-").concat(index), value: item.value }, item.text === undefined || item.text === null ? item.value : item.text));
                })),
            error &&
                React.createElement(BaseErrorMessage, { className: 'error-message' }, error))); })));
};

export { EasyCalendar, EasyCheckbox, EasyCurrencyInput, EasyTextInput as EasyDropdown, EasyFormConsumer, FormWrapper as EasyFormWrapper, EasyNumberInput, EasyRadioInput, EasyTextInput$1 as EasyTextInput, EasyTextArea as EasyTextarea };
